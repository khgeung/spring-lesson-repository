...
function startAjax(){
	...
	xhr.open("get", "/test-ajax1?userId="+userId); // 서버에서 비동기 요청을 위한 함수
	xhr.send(); // 요청을 보낸다
