 ...
 * 
 * 1. common.CommonOutputLogging 별도 클래스와 메소드를 정의
 * 2. 각 Service 의 method 에서 재사용
 * **위 방안으로 작업 후 회고**
 * 잘 구현된 공통 컴포넌트를 import 해서 사용하는 것은 좋은 선택
 * 작업량이 줄어드는 면도 있지만 여전히 공통 또는 횡단 관심사에 대한 반복적인 작업은 피할 수 없었다 => 개선 방안 : AOP를 적용해 설계, 구현해보자
