...
//@Component
//@Order(2) //기본 MyBatis 예제는 테스트 마무리되었으므로 실행에서 일단 제외 시킨다.
...
//			System.out.println(p);
		...
		// 상품 아이디로 개별 상품 조회
//		Long productId = 1L;
//		Product product = productMapper.findAllProductById(productId);
...
//		
//		Product product2 = productMapper.findAllProductById(productId);
//		logger.debug("수정된 상품정보 확인 {}", product2);
		
		// 상품 등록 후 primary key 인 product_id 에 자동 생성된 정보를 확보했는지 확인 
