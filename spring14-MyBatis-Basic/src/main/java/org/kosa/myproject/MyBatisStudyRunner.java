...
public class MyBatisStudyRunner implements CommandLineRunner {
    ...
    private final Spring14MyBatisBasicApplication spring14MyBatisBasicApplication;
	private final MemberMapper memberMapper;

	public MyBatisStudyRunner(MemberMapper memberMapper, Spring14MyBatisBasicApplication spring14MyBatisBasicApplication) {
		super();
		this.memberMapper = memberMapper;
		this.spring14MyBatisBasicApplication = spring14MyBatisBasicApplication;
	}
...
//		// id가 mybatis 인 회원의 password 와 name 과 address 를 수정한다
