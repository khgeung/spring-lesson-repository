...
//		System.out.println("DirectorStudyRunner");
		/**
		 * TABLE Director 의 리스트 정보를 받환받아 출력 org.kosa.myproject.mapper.DirectorMapper
		 * DirectorMapper interface 와 DirectorMapper xml 을 정의하여 아래 메소드가 정상적으로 수행하여 출력되도록
		 * 구현
		 */
...
//			//ROUND(AVG(m.attendance),0) AS averageAttendance 와 AS 로 별칭을 준 이름이 map의 key로 반환된다.
